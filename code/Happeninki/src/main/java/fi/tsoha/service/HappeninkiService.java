...
public class HappeninkiService {
    ...
    public Tila luoUusiKayttaja(String nimi, String tunnus, String salasana,
                                String sahkoposti) throws NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    public Tila luoUusiTapahtuma(String nimi, String kuvaus, String pvm, int toistuvuus, boolean voimassa,
                                 int kayttajaId) throws NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    public Tila poistaTapahtuma(int id) {
        ...
        try {
            List<Osallistuja> osallistujat = dao.osallistujaLista(id);
            
            for(Osallistuja o : osallistujat) {
                dao.poistaOsallistuja(o.getId());
            }
    ...
    public Tila luoUusiOsallistuja(String nimi, String sahkoposti, boolean osallistuu, int ryhmaId,
                                   int tapahtumaId) throws NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    public Tila luoUusiRyhma(String nimi, String kuvaus, int kayttajaId) throws NoSuchAlgorithmException,
                                                                                UnsupportedEncodingException {

        Tila tila = new Tila();
        tila.setKoodi(0);
        tila.setViesti("Ryhmä luotu!");
    ...
    public Tila poistaRyhma(int id) {
        Tila tila = new Tila();
        tila.setKoodi(0);
        tila.setViesti("Ryhmä #" + id + " poistettu!");
    ...
    public Tila paivitaRyhma(int id, String nimi, String kuvaus) {
        Tila tila = new Tila();
        tila.setKoodi(0);
        tila.setViesti("Ryhmä päivitetty!");
    ...
    public List<Ryhma> listaaRyhmat(int kayttajaId) throws SQLException {
        List<Ryhma> lista = new ArrayList<Ryhma>();
        try {
            lista = dao.ryhmaLista(kayttajaId);
        } catch (SQLException e) {
            throw new SQLException("Virhe ryhmien listauksessa: " + e.getMessage(), e);
        }
        return lista;
    }
